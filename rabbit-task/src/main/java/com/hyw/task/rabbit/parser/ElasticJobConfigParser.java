package com.hyw.task.rabbit.parser;
...
import com.hyw.task.rabbit.autoconfig.JobZookeeperProperties;
import com.hyw.task.rabbit.enums.ElasticJobTypeEnum;
...
public class ElasticJobConfigParser implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public ElasticJobConfigParser(ZookeeperRegistryCenter zookeeperRegistryCenter, JobZookeeperProperties jobZookeeperProperties) {
